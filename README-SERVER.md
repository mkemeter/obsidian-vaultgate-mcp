...
| **Docs** | This README | [README-TRAY.md](README-TRAY.md) |

The rest of this document covers the **headless npm path**. For the tray companion, see [README-TRAY.md](README-TRAY.md).
...
See [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md) for architecture overview, tool implementation guide, and the PR checklist.
