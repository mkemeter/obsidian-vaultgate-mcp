...
# Side effect: the startup health check runs `obsidian help` — if Obsidian isn't
# already open, this will auto-launch Obsidian.
...
echo "  See systemd/README.md for details."
